...
public class DataService {
	...
	public void updateCoreKpi(HashMap<String, String> params) {
		...
		String sql = "update rp_core_kpi set fixed_time_money=?, fund_money=?, current_money=? where version_key=? and period_key=? and time_key=?";
